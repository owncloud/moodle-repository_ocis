...
class SharingLink implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'sharingLink';
    ...
    */
     ...
     */
    public function getType(): ?\OpenAPI\Client\Model\SharingLinkType
    {
     ...
     * @return $this
     */
    public function setType(?\OpenAPI\Client\Model\SharingLinkType $type): static
    {
        if (is_null($type)) {
     ...
     * @return $this
     */
    public function setPreventsDownload(?bool $prevents_download): static
    {
     ...
     * @return string|null
     */
    public function getAtLibreGraphDisplayName(): ?string
    {
     ...
     * @return $this
     */
    public function setAtLibreGraphDisplayName(?string $at_libre_graph_display_name): static
    {
     ...
     * @return bool|null
     */
    public function getAtLibreGraphQuickLink(): ?bool
    {
     ...
     * @return $this
     */
    public function setAtLibreGraphQuickLink(?bool $at_libre_graph_quick_link): static
    {
